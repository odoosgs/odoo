(function () {
    ...
    console.log("Solicitando coordenadas para Ruta ID:", rutaId);
    ...
    try {
        ...
        // DEPURACIÓN: Si el resultado está vacío, sabremos que el error es de Odoo
        if (!data.result || data.result.length === 0) {
            console.error("Odoo no devolvió puntos para la ruta:", rutaId);
            return;
        }
        ...
        const map = L.map("route-map").setView([points[0].lat, points[0].lng], 6);
