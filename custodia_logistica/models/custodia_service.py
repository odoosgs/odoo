...
class CustodiaService(models.Model):
    ...
    operador2_nombre = fields.Char(string='Nombre del operador 2')          # opcional
    operador2_licencia = fields.Char(string='Licencia del operador 2')      # opcional
    tel_monitoreo_1 = fields.Char(string='Teléfono central de monitoreo 1', required=True)
    tel_monitoreo_2 = fields.Char(string='Teléfono central de monitoreo 2') # opcional
